...
def main():
    ...
    print 'All intra mean = %.3f | var = %.3f | std = %.3f' % (all_intra_mean, all_intra_var, all_intra_std)
    print 'All inter mean = %.3f | var = %.3f | std = %.3f' % (all_inter_mean, all_inter_var, all_inter_std)
    print 'DSMI intra mean = %.3f | var = %.3f | std = %.3f' % (dsmi_intra_mean, dsmi_intra_var, dsmi_intra_std)
    print 'DSMI inter mean = %.3f | var = %.3f | std = %.3f' % (dsmi_inter_mean, dsmi_inter_var, dsmi_inter_std)
    print 'FCE intra mean = %.3f | var = %.3f | std = %.3f' % (fce_intra_mean, fce_intra_var, fce_intra_std)
    print 'FCE inter mean = %.3f | var = %.3f | std = %.3f' % (fce_inter_mean, fce_inter_var, fce_inter_std)
    print 'Both intra mean = %.3f | var = %.3f | std = %.3f' % (both_intra_mean, both_intra_var, both_intra_std)
    print 'Both inter mean = %.3f | var = %.3f | std = %.3f' % (both_inter_mean, both_inter_var, both_inter_std)
